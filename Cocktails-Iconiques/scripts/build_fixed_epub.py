...
<package xmlns="http://www.idpf.org/2007/opf" version="3.0" unique-identifier="bookid" prefix="rendition: http://www.idpf.org/vocab/rendition/#">
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
    <dc:identifier id="bookid">urn:uuid:cocktails-iconiques</dc:identifier>
...
""",
    ...
    epub_path = OUTPUT_DIR / "Cocktails-Iconiques-kdp-source.epub"
    if epub_path.exists():
        epub_path.unlink()
...
def main() -> None:
    ...
    if len(images) != 22:
        raise SystemExit(f"Expected 22 pages, found {len(images)}")
